...
ALWI void sub_bcast_rows_init_short_with_dt(uint32_t icb0 = 0, uint32_t icb1 = 1) {
    ...
    reconfig_data_format(icb0, icb1);
#endif
    MATH((llk_math_eltwise_binary_init<ELWSUB, BroadcastType::ROW, MathFidelity::LoFi>(icb0, icb1)));  // TODO(AP)
...
ALWI void sub_tiles_bcast_rows_to_cb(
    ...
    {
        MATH((llk_math_eltwise_binary_init<ELWSUB, BroadcastType::ROW, MathFidelity::LoFi>(icb0, icb1)));
