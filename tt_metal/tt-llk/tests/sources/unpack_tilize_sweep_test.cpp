...
void run_kernel(RUNTIME_PARAMETERS params)
{
    ...
    _llk_pack_init_wrapper_<UNTILIZE, false /* zero_output */, TILIZE>(
        formats.pack_dst, FACE_R_DIM, TILE_C_DIM, params.num_faces, false /* partial_face */, params.NARROW_TILE);
    _llk_pack_dest_init_wrapper_<DstSync::SyncHalf, is_fp32_dest_acc_en, UNTILIZE>(FACE_R_DIM, params.NARROW_TILE);
