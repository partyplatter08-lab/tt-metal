...
def test_recip_fixed(device, h, w):
    # Golden caps recip(0) at a large finite value; device returns +inf.
    # Behavioral difference — kept on PCC.
    run_math_unary_test_fixed_val(device, h, w, 0.0, ttnn.reciprocal, pcc_check=True)
